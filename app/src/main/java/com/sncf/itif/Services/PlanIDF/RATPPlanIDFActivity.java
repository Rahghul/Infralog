 ...
 */
public class RATPPlanIDFActivity extends Activity implements ServiceCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ratp_plan_idf);
    ...
    public void callServicePlanIDF() {
        ...
        servicePlanIDF.enquiry(getResources().getString(R.string.dns)
                + getResources().getString(R.string.url_divers_img_IDF));
    }
