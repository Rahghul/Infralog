...
public class CustomAdapterInfo extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvDegree = (TextView) convertView.findViewById(R.id.tvDegree);
        ...
        holder.tvDegree.setText(infoList.get(position).getDegree());
        ...
        holder.tvDegree.setTag(String.valueOf(position));
